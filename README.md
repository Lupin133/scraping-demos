...
## AI Act EU Article 50 disclosure

This repository's code is produced through an AI-assisted workflow: scope analysis, code drafting, and test scaffolding are partially generated by Claude (Anthropic). Human review, final delivery, and accountability rest with Tom Engels.
